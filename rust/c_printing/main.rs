fn main() {
	...
	println!("The smallest i128 is {} and the biggest i8 is {}.",i128::MIN,i128::MAX);
	...
	println!("{city1} is in {country} and {city2} is also in {country}, but {city3} is not in {country}",city1="Helsinki",city2="Tampere",city3="Stockholm",country="Finland");
}